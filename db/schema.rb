...
ActiveRecord::Schema[7.0].define(version: 2022_07_16_023719) do
  ...
  create_table "order_items", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "status", default: "Payment is pending"
  end

  create_table "order_line_items", charset: "utf8mb3", force: :cascade do |t|
    t.integer "order_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "ordered_products", charset: "utf8mb3", force: :cascade do |t|
    t.string "title"
